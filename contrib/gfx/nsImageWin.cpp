                 ...
                 PRInt32 aDX, PRInt32 aDY, PRInt32 aDWidth, PRInt32 aDHeight)
{
  ...
  if (!mIsOptimized || !mHBitmap) {
    ...
    // [ghzil] {
	__declspec(dllimport) void nsImageWin_Draw_19( void *, HDC, void *, signed char *, int, int, int, int);
	nsImageWin_Draw_19( this, TheHDC, mAlphaBits, &mAlphaDepth, aDWidth, aDHeight, aDX, aDY);
	// } [ghzil]
  ((nsDrawingSurfaceWin *)aSurface)->ReleaseDC();
