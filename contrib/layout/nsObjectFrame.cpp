                                 ...
                                 nsIURI* aURI)
{
  ...
  // [ghzil] disabled plugins from this list {
  if(nsnull == PL_strcasecmp(aMimeType, "application/x-shockwave-flash"))
      return NS_ERROR_FAILURE;
  if(nsnull == PL_strcasecmp(aMimeType, "application/x-director"))
      return NS_ERROR_FAILURE;
  // } [ghzil]
