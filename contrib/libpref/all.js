...
// [ghzil] {
pref("browser.anchor_color", "#999999");
pref("browser.display.foreground_color", "#999999");
pref("browser.display.use_document_colors", false);
pref("browser.visited_color", "#C0C0C0");
